...
(
    ...
    holiday	VARCHAR(512),
    weekday	VARCHAR(512),
    workingday	VARCHAR(512),
    weathersit	VARCHAR(512),
    temp	DOUBLE,
    atemp	DOUBLE,
    hum	DOUBLE,
    windspeed	DOUBLE,
...
INSERT INTO rental (instant, dteday, season, yr, mnth, holiday, weekday, workingday, weathersit, temp, atemp, hum, windspeed, casual, registered, cnt) VALUES
